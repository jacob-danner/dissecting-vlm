...
def insert_image_distributions(
    ...
    Args:
        ...
        distributions: Output from extract_image_token_distributions
    ...
    for dist in distributions:
        ...
        for token_id, token_text, probability, rank in dist['tokens']:
...
def query_position_tokens(
    ...
    Returns:
        List of {token_text, avg_probability, frequency} dicts
    """
